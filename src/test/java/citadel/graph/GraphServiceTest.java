...
class GraphServiceTest {
  ...
  void paintsOwnClassesNodesWithNoTransparencyOthersWithTransparency80Percents() {
    // given
    ClassDefinition classDefinition = new ClassDefinition("citadel.package.Class1",
    ...
    assertThat(node.get("color"), equalTo("#d8ce00ff"));  //ff for 255 in hex - most bright color
