...
class GraphSpec extends Specification {
    ...
    def 'Builds correct classes graph'() {
        ...
        response.body().contains(""""citadel.AppWebController" -> "citadel.AppRestController\"""");
        response.body().contains(""""citadel.AppWebController" -> "org.springframework.web.bind.annotation.RequestParam\"""");
        response.body().contains(""""citadel.AppRestController" -> "org.springframework.web.bind.annotation.RequestParam\"""");

        and: 'nodes has expected style'
        response.body().contains(""""citadel.AppWebController" ["style"="filled","fixedsize"="true","width"="3.0","height"="3.0","color"="#d80000ff"]""");
        response.body().contains(""""citadel.AppRestController" ["style"="filled","fixedsize"="true","width"="3.0","height"="3.0","color"="#d80000ff"]""");
